...
class PieChartSet extends StatefulWidget {
  const PieChartSet(
  ...
  @override
  _PieChartSetState createState() => _PieChartSetState(IncomeOrExpense,TileWidthAllAccounts,TileHeightAllAccounts);
}

class _PieChartSetState extends State<PieChartSet> with TickerProviderStateMixin {
  ...
  _PieChartSetState(this.IncomeOrExpense,this.TileWidthAllAccounts,this.TileHeightAllAccounts);
                      ...
                      builder: (BuildContext context, Widget? child) {
                        return FadeTransition(
                          ...
                          child: Transform(
                              ...
                              :Padding(
                                padding:  EdgeInsets.only(right: ChartSet[index]==ChartSet[0] && IncomeOrExpense=="Both"? 20:0),
