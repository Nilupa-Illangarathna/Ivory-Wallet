...
class Clusters{
  ...
  int DaysBetween;
  int percentage;
  Clusters(this.Category,this.percentage,this.DaysBetween);
}

class ClusturedSingleCategory{
  List <Clusters> ClusturedDataSetForSingleCategory;
  ClusturedSingleCategory(this.ClusturedDataSetForSingleCategory);
}

class ClusturedSingleCategorySet{
  List <ClusturedSingleCategory> ClusturedDataSetsOfAllCategories;
  ClusturedSingleCategorySet(this.ClusturedDataSetsOfAllCategories);
}