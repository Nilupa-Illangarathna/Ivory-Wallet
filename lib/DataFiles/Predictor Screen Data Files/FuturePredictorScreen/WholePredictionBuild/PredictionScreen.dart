...
import '../NetPredictionsWidget/NetPredictionsWidget.dart';
...
class _MyDiaryScreenState extends State<MyDiaryScreen>
  ...
  void addAllListData() async{
    ...
    listViews.add(
      await TitleView(
        titleTxt: 'Predicted end of the month',
        subTxt: 'Compared to budget',
    ...
    listViews.add(
      await TitleView(
        titleTxt: 'Predicted monthly total amounts per Category',
        subTxt: 'Incomes',
        animation: Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: widget.animationController!,
            curve:
