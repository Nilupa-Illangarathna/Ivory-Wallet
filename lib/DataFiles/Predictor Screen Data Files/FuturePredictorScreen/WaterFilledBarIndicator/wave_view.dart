...
class WaveView extends StatefulWidget {
  ...
  const WaveView({Key? key, this.percentageValue = 100.0,required this.BarColorDark,required this.BarColor}) : super(key: key);
  @override
  _WaveViewState createState() => _WaveViewState(BarColorDark,BarColor);
}
...
class _WaveViewState extends State<WaveView> with TickerProviderStateMixin {
  ...
  _WaveViewState(this.BarColorDark,this.BarColor);
      ...
      child: new AnimatedBuilder(
        ...
        builder: (context, child) => new Stack(
          children: <Widget>[
            ...
            widget.percentageValue!= -20?
            (widget.percentageValue >100?
                Container(
                  height: 0,
                  width: 0,
                )
