...
class AllTransectionsDatabase{
  static final AllTransectionsDatabase instance = AllTransectionsDatabase._init();

  static Database? _database1;

  AllTransectionsDatabase._init();

  Future<Database> get database async{
    if(_database1!=null) return _database1!;

    _database1 = await _initDB('AllTransections.db');
    return _database1!;
  }
  ...
  Future _createDB(Database db, int version) async {
    ...
    await db.execute('''           
  CREATE TABLE $tableAllTransections (
