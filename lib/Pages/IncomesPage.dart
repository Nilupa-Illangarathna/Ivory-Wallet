...
class IncomesPage extends StatefulWidget {
  ...
  bool IsIncome;
  IncomesPage(this.IsIncome);

  @override
  _IncomesPageState createState() => _IncomesPageState(IsIncome);
}

class _IncomesPageState extends State<IncomesPage> {

  bool IsIncome;
  _IncomesPageState(this.IsIncome);


  var ColourList =ColorsClass();
  String dropdownValue = FiltersForTheApp.AccountType;

  List<DoughnutChartData> IncomechartData = DoughnutChartDataReturn(IncomeFilteredCategoryValuesforincomeExpenses(Currently_Using_Income_Categories));

  @override
  Widget build(BuildContext context) {
    IncomechartData = DoughnutChartDataReturn(IncomeFilteredCategoryValuesforincomeExpenses(Currently_Using_Income_Categories));
    return Scaffold(
      appBar: AppBar(
                ...
                children: [
                    ...
                    child: Container(
                        ...
                        child: RawMaterialButton(
                          ...
                          child: Container(
                            ...
                            child:Center(
                                child:Text("Expenses" , style: TextStyle( fontSize: 17,),)
                            ),
                          ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        new FourCategoryButtonsInARow(IsIncome,Currently_Using_Income_Categories, 0 ),
                        new TwoCategoryButtonsInARow(IsIncome,Currently_Using_Income_Categories, 0 ),
                        new TwoCategoryButtonsInARow(IsIncome,Currently_Using_Income_Categories, 1 ),
                        new FourCategoryButtonsInARow(IsIncome,Currently_Using_Income_Categories, 1 ),
                      ],
                    ),
                  ),
